...
public class DelayUtils {
  ...
  //    public final static long[] delayLevel = new long[]{0,1000,5000,10000,30000,60000,120000,180000,
//            240000,300000,360000,420000,480000,540000,600000,1200000,1800000,3600000,7200000};
  public final static long[] delayLevel = new long[]{0, 10000, 30000, 60000, 120000, 180000, 240000,
  ...
  public final static int getMaxDelayLevelBySec(long sec) {
    if (sec <= 0) {
      return 0;
    }
    if (sec <= delayLevel[1]) {
